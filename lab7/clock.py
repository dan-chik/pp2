...
def main():
    ...
    pygame.init()
    screen = pygame.display.set_mode((500, 500)) #800, 600
    ...
    # loading the images 
    clock_image = pygame.transform.scale(pygame.image.load('Picsart_23-03-29_23-52-20-558.jpg'), (500, 500)) #800, 600
    sechand_image = pygame.image.load('Picsart_23-03-29_23-52-39-273.png')
    sechand_image = pygame.transform.scale(sechand_image, (700, 450)) # 250, 75
    sechand_rect = sechand_image.get_rect()
    sechand_rect.center = (270, 250) # 400, 300
    minhand_image = pygame.image.load('Picsart_23-03-29_23-52-54-295.png')
    minhand_image = pygame.transform.scale(minhand_image, (600, 350)) # 200, 50
    minhand_rect = minhand_image.get_rect()
    minhand_rect.center = (250, 250)
